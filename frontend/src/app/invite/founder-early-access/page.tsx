...
export default function FounderEarlyAccessInvitePage() {
  ...
  if (isSuperAdmin) {
    ...
    const emailBody = encodeURIComponent(
      `Hello,\n\nUse this invite link to apply for the RiseFlowHub Early Founder scholarship (first 300 founders):\n${inviteLink}\n\nBest regards,\nRiseFlowHub Team`
    );
    return (
      <main className="min-h-screen flex items-center justify-center bg-background px-4">
        <div className="w-full max-w-2xl rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Share this link with founders. It enrolls eligible users into the first-300 scholarship flow.
          </p>
